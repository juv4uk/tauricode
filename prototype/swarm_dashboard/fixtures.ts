  ...
  recentTasks: [
    {
      ...
      description:
        "Implement real-time Swarm Mesh visualizer (ports 9101-9107), live Derivation DAG streamer, and phonetic inspection workbench.",
      status: "COMPLETED",
      priority: 0.95,
      capabilities: ["tauri", "dashboard", "telemetry", "ipc", "react", "phonetics"],
      context:
        "done: prototype/swarm_dashboard completed with standalone demo, IPC contracts, and recommendations report.",
    ...
    },
    {
      ...
      description:
        "Implement constant folding for pratyāhāra set algebra and single-cycle Sūtra 1.1.9 savarṇa predicates.",
      status: "COMPLETED",
      priority: 0.85,
    ...
    },
    {
      ...
      description:
        "Synthesizable 1-cycle Savarṇa unit, palatalization modifier, and distributed 64-bit ROM on Gowin GW5A.",
      status: "COMPLETED",
      priority: 0.9,
    ...
    },
    {
      ...
      description:
        "Formalize 8-bit phonetic allocation, 6 marker-sound collision resolution, and Slavic phonetic extensions.",
      status: "COMPLETED",
      priority: 0.95,
...
export const CANONICAL_DERIVATIONS: Record<string, DerivationTrace> = {
  bhavati: {
    ...
    description:
      "Derivation of root √bhū (भू सत्तायाम्, 1st gaṇa Bhvādi) in present tense 3rd person singular (laṭ, tiṅ-tip).",
    status: "success",
    ...
    states: [
        ...
        terms: [
          {
            ...
            source_form: "bhū",
            surface_form: "bhū",
            designations: ["dhātu", "aṅga", "bhvādi"],
          },
        ],
      ...
      },
      {
        ...
        terms: [
          ...
          },
          {
            ...
            source_form: "laṭ",
            surface_form: "laṭ",
            designations: ["vartamāna", "prathama"],
          },
        ],
        applied_rule: {
          sutra_id: "3.2.123",
      ...
      },
      {
        ...
        terms: [
          ...
          {
            id: "term:pratyaya-tip",
            kind: "pratyaya",
            source_form: "tip",
            surface_form: "tip",
            designations: ["tiṅ", "parasmaipada", "pit"],
          },
        ],
        applied_rule: {
          sutra_id: "3.4.78",
      ...
      },
      {
        ...
        terms: [
          ...
          },
          {
            ...
            source_form: "śap",
            surface_form: "a",
            designations: ["vikaraṇa", "sārvadhātuka"],
          },
          {
            id: "term:pratyaya-ti",
            kind: "pratyaya",
        ...
        terms: [
          {
            ...
            source_form: "bhū",
            surface_form: "bho",
            designations: ["aṅga", "guṇa-applied"],
          },
          {
            id: "term:vikarana-a",
            kind: "pratyaya",
        ...
        terms: [
          {
            ...
            source_form: "bho",
            surface_form: "bhav",
            designations: ["aṅga", "sandhi-applied"],
          },
          {
            id: "term:vikarana-a",
            kind: "pratyaya",
        ...
        terms: [
          {
            ...
            designations: ["pada", "tiṅanta", "kartari", "lat", "prathama", "ekavacana"],
          },
        ],
        applied_rule: {
          sutra_id: "1.4.14",
  ...
  dadati: {
    ...
    description:
      "Derivation of root √dā (डुदाञ् दाने, 3rd gaṇa Juhotyādi) in present tense 3rd person singular showing Paribhāṣā conflict resolution (Ślu blocking Śap by Apavāda).",
    status: "success",
    ...
    states: [
        ...
        terms: [
          {
            ...
            source_form: "dā",
            surface_form: "dā",
            designations: ["dhātu", "ślu-environment"],
          },
          { id: "term:pratyaya-ti", kind: "pratyaya", source_form: "tip", surface_form: "ti", designations: ["tiṅ"] },
        ],
        applied_rule: {
      ...
      },
      {
        ...
        terms: [
          {
            id: "term:abhyasa-da-short",
            kind: "abhyAsa",
            source_form: "dā",
            surface_form: "da",
            designations: ["abhyāsa", "hrasva"],
          },
          { id: "term:root-da", kind: "dhAtu", source_form: "dā", surface_form: "dā", designations: ["dhātu", "aṅga"] },
          { id: "term:pratyaya-ti", kind: "pratyaya", source_form: "tip", surface_form: "ti", designations: ["tiṅ"] },
        ],
      ...
      },
      {
        ...
        terms: [
          {
            id: "term:final-pada-dadati",
            kind: "pada",
            source_form: "dā+tip",
            surface_form: "dadāti",
            designations: ["pada", "tiṅanta", "juhotyādi", "prathama", "ekavacana"],
          },
        ],
        applied_rule: {
          sutra_id: "1.4.14",
