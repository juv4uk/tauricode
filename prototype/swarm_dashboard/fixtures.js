    ...
    states: [
      {
        id: "S0",
        step_index: 0,
        terms: [{ surface_form: "bhū", kind: "dhAtu" }],
      ...
      },
      {
        ...
        step_index: 1,
        terms: [
          { surface_form: "bhū", kind: "dhAtu" },
          { surface_form: "laṭ", kind: "lakAra" },
        ],
      ...
      },
      {
        ...
        terms: [
          { surface_form: "bhū", kind: "dhAtu" },
          { surface_form: "tip", kind: "pratyaya" },
        ],
      ...
      },
      {
        ...
        terms: [
          { surface_form: "bhū", kind: "dhAtu" },
          { surface_form: "śap", kind: "pratyaya" },
          { surface_form: "ti", kind: "pratyaya" },
        ],
      ...
      },
      {
        id: "S8",
        step_index: 8,
        terms: [{ surface_form: "bhavati", kind: "pada" }],
    ...
    states: [
      {
        id: "S0",
        step_index: 0,
        terms: [{ surface_form: "dā", kind: "dhAtu" }],
      ...
      },
      {
        ...
        applied_rule: { sutra_id: "2.4.75", paribhasha_principle: "Apavāda > Utsarga" },
      ...
      },
      {
        id: "S6",
        step_index: 6,
        terms: [{ surface_form: "dadāti", kind: "pada" }],
        hash: "state:sha256:1a84f339cf01cb4d14210459c3d40ef6731be7a7bf734e40e6573c52e8055627",
      },
    ],
    cryptographic_proof: { verified: true },
