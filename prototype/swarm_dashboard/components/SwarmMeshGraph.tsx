...
export const SwarmMeshGraph: React.FC<SwarmMeshGraphProps> = ({
  topology,
  selectedNodeId,
  onSelectNode
}) => {
    ...
    <div className="relative w-full rounded-xl bg-slate-900/80 border border-slate-800 p-4 shadow-xl backdrop-blur">
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-4 text-xs font-mono text-slate-400">
          <span>Active Nodes: <strong className="text-emerald-400">{topology.activeNodesCount}/6</strong></span>
          <span>Mesh Health: <strong className="text-sky-400">{topology.meshHealthPct}%</strong></span>
          <span>Tasks: <strong className="text-purple-400">{topology.totalTasksCompleted}</strong></span>
        </div>
      </div>
